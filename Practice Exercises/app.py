...
#----Developed by Alvin ondieki -- 0700921906-------------------------

#--importimg necessary libaries
import pandas as pd
...
#--path to users registered users data-------
...
def add_user_ui():
    st.sidebar.subheader(f"**{st.session_state.username}** ,Welcome Back")
    st.sidebar.subheader("👤 Admin - Add New User")
...
def load_sarcasm_detector():
    ...
    the "TwitterData/sarcasm1_model" directory.
    """
    return pipeline("text-classification", model="TwitterData/sarcasm1_model", tokenizer="TwitterData/sarcasm1_model")
